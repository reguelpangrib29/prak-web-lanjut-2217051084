    ...
    <div class="p-card u-align--center">
        ...
        <div class="flex justify-end mb-6">
            <a href="{{ route('user.list') }}"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-lg transition duration-300">
                List User
            </a>
        </div>
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="p-form__group mb-4">
                ...
                <input type="text" id="nama" name="nama"
                    class="p-form__input w-full p-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div class="p-form__group mb-4">
                ...
                <select name="kelas_id" id="kelas_id"
                    class="w-full p-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    required>
            ...
            <div class="p-form__group mb-4">
                ...
                <select name="jurusan_id" id="jurusan_id"
                    ...
                    <option value="{{ $jurusanItem->id }}"
                        {{ old('jurusan_id', $user->jurusan_id ?? '') == $jurusanItem->id ? 'selected' : '' }}>
            ...
            <div class="p-form__group">
                <button type="submit"
                    class="w-full bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg shadow-lg transition duration-300">
                    Update
                </button>
            </div>
        </form>

...
<div class="frame">
    <div class="p-card u-align--center">
        ...
        <!-- Form untuk menyimpan user baru -->
        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" class="p-form p-form--stacked">
            @csrf
            ...
            <div class="p-form__group mb-4">
                ...
                <input type="text" id="nama" name="nama" class="p-form__input w-full p-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('nama', $user->nama ?? '') }}" required>
                @error('nama')
            ...
            <div class="p-form__group mb-4">
                ...
                <input type="text" id="npm" name="npm" class="p-form__input w-full p-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('npm', $user->npm ?? '') }}" required>
                @error('npm')
                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
